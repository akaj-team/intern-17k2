...
import vn.asiantech.internship.uploadimage.UploadImageActivity;

public class SplashActivity extends AppCompatActivity implements SplashAdapter.OnClickListener {
    private final List<String> mDays = Arrays.asList("Day 1", "Day 3", "Day 5", "Day 7", "Day 11", "Day 11", "Day 12", "Day 15", "Day 16", "Day 20", "Day 23");
