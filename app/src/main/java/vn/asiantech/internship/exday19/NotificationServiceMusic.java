...
public class NotificationServiceMusic extends Service {
    ...
    private void showNotification() {
        ...
        mBuilder.setSmallIcon(R.drawable.img_album_art)
    ...
    private void updateNotification() {
        ...
        if (mMediaPlayer.isPlaying()) {
            ...
            mRemoteViewsBig.setImageViewResource(R.id.imgPlay, R.drawable.img_pause);
            mRemoteViewsSmall.setImageViewResource(R.id.imgPlay, R.drawable.img_pause);
        } else if (!mMediaPlayer.isPlaying()) {
            intentPlaySong.setAction(Action.RESUME.getValue());
            mRemoteViewsBig.setImageViewResource(R.id.imgPlay, R.drawable.img_play);
            mRemoteViewsSmall.setImageViewResource(R.id.imgPlay, R.drawable.img_play);
        }
