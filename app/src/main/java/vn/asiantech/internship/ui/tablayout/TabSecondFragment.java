...
public class TabSecondFragment extends Fragment {
    ...
    private void initViewPager() {
        mViewPagerTab2.setAdapter(new Tab2ViewPagerAdapter(getContext(), mImage));
    ...
    private void changeDurationScroll() {
        try {
            ...
            SpeedScroll scroller = new SpeedScroll(mViewPagerTab2.getContext(), new AccelerateInterpolator());
            mScroller.set(mViewPagerTab2, scroller);
        } catch (Exception e) {
